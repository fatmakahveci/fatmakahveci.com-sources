...
- It read or retrieve a resource.
...
- It starts a two-way communications (a tunnel) with the requested resource.
...
- TCP and IP are the basic rules that defines the Internet.
- TCP is a standard that defines how to establish and maintain a network conversation by which applications can exchange the data.
  ...
  - It handles retransmission of dropped or grabled packets, as it's meant to provide error-free data transmission.
