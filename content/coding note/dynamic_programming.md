...
summary: "Dynamic Programming (DP)"
date: 18-02-2023
categories:
  - "Coding"
tags:
...
- It is implemented with nested for loops and an array.
...
- _Memoizing a result_ means to store the result of a function call, usually in a hashmap or an array, so that when the same function call is made again, we can simply return the memoized result instead of recalculating the result.
...
## How to convert top-down solution to the bottom-up
...
- Set your base cases, same as the top-down function's.
- Write a for loop that iterate over the state variables. If you have multiple states, you will need nested for loops. These loops should start iterating from the base cases.
...
- Common state variables:
  ...
  3. Explicit numerical constraints given in the problem, $k$.
...
- i.e. House Robber Problem
  - The only state variable is an integer $i$, that indicates the index of a house.
