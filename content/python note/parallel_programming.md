...
- To parallelize a function, initialize a Pool with n number of processors and pass the function you want to parallelize to one of Pool parallelization methods.
