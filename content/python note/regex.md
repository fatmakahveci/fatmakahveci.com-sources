...
- word boundary, matches if the specified characters are at the beginning or at the end. i.e.,
  - \bfoo := football
  - foo\b := the foo

## \B

- not word boundary, matches if the specified characters are NOT at the beginning or at the end. i.e.,
  - \Bfoo := a football, etc.
