...
- A module is a file containing definitions and implementations of classes, functions that can be used inside another program, variables.

- Do not use `import *` because it affects the readability.
