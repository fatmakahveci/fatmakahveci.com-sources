...
- A region of a physical memory storage used to temporarily store data while it is being moved from one place to another, typically in the computer's memory.
