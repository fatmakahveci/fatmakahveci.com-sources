...
tags:
  ...
  - "data structures"
---
- Heap is a special tree-based data structure, which is an almost complete tree that satisfies the heap propety:
...
- Binary heap is a complete binary tree with the following properties:
  - **Shape property:** All levels are completely filled except possibly the last level. The last level has all keys as left as possible so binary heap makes them suitable to be stored in an array.
...
- It is similar to queue, but here values come out in order by priority.
