...
- Choose if you are newbie for python and have the time and disk space.

- Install 1,500 scientific packages automatically installed __at once__.

- Everytime you open up a terminal, conda won’t automatically be available. Run the command below to use conda within miniconda.
...
[Ref 1](https://conda.io/en/latest/), [Ref 2](https://docs.conda.io/projects/conda/en/latest/user-guide/install/macos.html), and [Ref 3](https://geohackweek.github.io/Introductory/01-conda-tutorial/).
