...
- It is a set of tools that support distributed map and reduce style programming through Hadoop MapReduce.
- It is for batch processing of big datasets.
- It uses distributed file system for storing big data and MapReduce to process it.
...
- `Map` transforms the data by dividing into key/value pairs, getting the output from a map as an input.
