...
- You provide a sequence of iterable of hashable objects as an argument to the class's constructor.
...
# you can pass any iterable as an input, such as string and a list of objects.
deque('abc') # ['a', 'b', 'c']
...
def search(lines, pattern, history=5):
  ...
  # is removed from the right side, vice versa for
  # the right.
...
- `list` is based on arrays, `deque` is based on a doubly linked list.
