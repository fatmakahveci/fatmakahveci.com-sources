...
- There is no such things as integer except `BigInt`.
...
- isNaN(NaN); # to test whether if it is numeric.
...
- A simple collections of name-value pairs. It is similar to dictionaries in python.
...
- Differences and Limitations:
  - It doesn't have its own bindings to `this` or `super`, and shouldn't be used as methods.
...
- Prototype of an object is a pointer to another object.
